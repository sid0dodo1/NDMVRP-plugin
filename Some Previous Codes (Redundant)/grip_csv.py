...
def grip():
    ...
    default_location_of_CSV = QFileDialog.getExistingDirectory(
        None, "Select the Folder Containing the Files")
    if not default_location_of_CSV:
        print("No folder selected. Exiting.")
        return

    # default_location_of_CSV = "C:/Users/rahul/Downloads/output/"

    csv_0_Cargo = pd.read_csv(os.path.join(default_location_of_CSV, '0 Cargo.csv'))
    csv_0_Vehicles = pd.read_csv(os.path.join(default_location_of_CSV, '0 Vehicles.csv'))
    csv_1_Locations_and_PickUp_Delivery_details = pd.read_csv(os.path.join(default_location_of_CSV, "1 Locations and PickUp Delivery details.csv"))
    csv_1_Vehicle_Cargo_Compatibility_and_Loading_Unloading_Time = pd.read_csv(os.path.join(default_location_of_CSV,"1 Vehicle Cargo Compatibility and Loading Unloading Time.csv"))
    ...
    csv_0_PickUp.drop(
        ["Pickup / Delivery", "Remarks / Comments"], axis=1, inplace=True)
    ...
    csv_0_Vehicle_Specifications['Must vehicles of this type finally return to their respective starting depots?'].replace(
        {1: 'Yes', 0: 'No'}, inplace=True)  # Replace 1's with 'Yes' and 0's with 'No'
    ...
    Vehicles_Specifications_WeightCapacity_dict = csv_0_Vehicle_Specifications[
        "Weight Capacity"]
    Vehicles_Specifications_VolumeCapacity_dict = csv_0_Vehicle_Specifications[
        "Volume Capacity"]
    Vehicles_Specifications_OpenTour_dict = csv_0_Vehicle_Specifications[
        "Must vehicles of this type finally return to their respective starting depots?"]
    Vehicles_Specifications_VehicleNetworkCompatibility_dict = csv_0_Vehicle_Specifications[
        "Vehicle Network Compatibility (OSM)"]

    csv_1_Vehicle_Depots = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "Vehicle Depot"]
    csv_1_Vehicle_Depots = csv_1_Vehicle_Depots[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Vehicles_Specifications_VehicleType_arr]
    csv_1_Vehicle_Depots[Vehicles_Specifications_VehicleType_arr] = csv_1_Vehicle_Depots[Vehicles_Specifications_VehicleType_arr].astype(
        int)  # Convert columns to integer inplace
    ...
    LocationPickupDelivery_VehicleDepots_Description_dict = csv_1_Vehicle_Depots[
        "Description"]
    ...
    for Vehicle_Type in Vehicles_Specifications_VehicleType_arr:
        LocationPickupDelivery_VehicleDepots_VehicleTypesAvailable_dict[
            Vehicle_Type] = csv_1_Vehicle_Depots[Vehicle_Type]

    csv_1_Warehouses = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "WareHouse"]
    csv_1_Warehouses = csv_1_Warehouses[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Cargo_Delivery_Type_arr]
    csv_1_Warehouses[Cargo_Delivery_Type_arr] = csv_1_Warehouses[Cargo_Delivery_Type_arr].astype(
        int)  # Convert columns to integer inplace
    ...
    for CompatibleCargo_Delivery_Type in Cargo_Delivery_Type_arr:
        LocationPickupDelivery_Warehouses_DeliveryCargoAvailable_dict[
            CompatibleCargo_Delivery_Type] = csv_1_Warehouses[CompatibleCargo_Delivery_Type]

    csv_1_SimultaneousNodes = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "Simultaneous Node"]
    csv_1_SimultaneousNodes = csv_1_SimultaneousNodes[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr]
    csv_1_SimultaneousNodes[Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr] = csv_1_SimultaneousNodes[Cargo_Delivery_Type_arr +
                                                                                                     Cargo_PickUp_Type_arr].astype(int)  # Convert columns to integer inplace
    ...
    LocationPickupDelivery_SimultaneousNodes_Description_dict = csv_1_SimultaneousNodes[
        "Description"]
    LocationPickupDelivery_SimultaneousNodes_Latitude_dict = csv_1_SimultaneousNodes[
        "Latitude"]
    LocationPickupDelivery_SimultaneousNodes_Longitude_dict = csv_1_SimultaneousNodes[
        "Longitude"]

    LocationPickupDelivery_SimultaneousNodes_DeliveryCargoRequired_dict = {}
    for CompatibleCargo_Delivery_Type in Cargo_Delivery_Type_arr:
        LocationPickupDelivery_SimultaneousNodes_DeliveryCargoRequired_dict[
            CompatibleCargo_Delivery_Type] = csv_1_SimultaneousNodes[CompatibleCargo_Delivery_Type]
    ...
    for CompatibleCargo_PickUp_Type in Cargo_PickUp_Type_arr:
        LocationPickupDelivery_SimultaneousNodes_PickUpCargoAwaiting_dict[
            CompatibleCargo_PickUp_Type] = csv_1_SimultaneousNodes[CompatibleCargo_PickUp_Type]

    csv_1_TranshipmentPorts = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "Transhipment Port"]
    csv_1_TranshipmentPorts = csv_1_TranshipmentPorts[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr]
    csv_1_TranshipmentPorts[Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr] = csv_1_TranshipmentPorts[Cargo_Delivery_Type_arr +
                                                                                                     Cargo_PickUp_Type_arr].astype(int)  # Convert columns to integer inplace
    ...
    LocationPickupDelivery_TranshipmentPorts_Description_dict = csv_1_TranshipmentPorts[
        "Description"]
    LocationPickupDelivery_TranshipmentPorts_Latitude_dict = csv_1_TranshipmentPorts[
        "Latitude"]
    LocationPickupDelivery_TranshipmentPorts_Longitude_dict = csv_1_TranshipmentPorts[
        "Longitude"]

    LocationPickupDelivery_TranshipmentPorts_DeliveryCargoCompatible_dict = {}
    for CompatibleCargo_Delivery_Type in Cargo_Delivery_Type_arr:
        LocationPickupDelivery_TranshipmentPorts_DeliveryCargoCompatible_dict[
            CompatibleCargo_Delivery_Type] = csv_1_TranshipmentPorts[CompatibleCargo_Delivery_Type]
    LocationPickupDelivery_TranshipmentPorts_PickUpCargoCompatible_dict = {}
    for CompatibleCargo_PickUp_Type in Cargo_PickUp_Type_arr:
        LocationPickupDelivery_TranshipmentPorts_PickUpCargoCompatible_dict[
            CompatibleCargo_PickUp_Type] = csv_1_TranshipmentPorts[CompatibleCargo_PickUp_Type]

    csv_1_SplitNodes = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "Split Node"]
    csv_1_SplitNodes = csv_1_SplitNodes[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr]
    csv_1_SplitNodes[Cargo_Delivery_Type_arr+Cargo_PickUp_Type_arr] = csv_1_SplitNodes[Cargo_Delivery_Type_arr +
                                                                                       Cargo_PickUp_Type_arr].astype(int)  # Convert columns to integer inplace
    ...
    for CompatibleCargo_Delivery_Type in Cargo_Delivery_Type_arr:
        LocationPickupDelivery_SplitNodes_DeliveryCargoRequired_dict[
            CompatibleCargo_Delivery_Type] = csv_1_SplitNodes[CompatibleCargo_Delivery_Type]
    LocationPickupDelivery_SplitNodes_PickUpCargoAwaiting_dict = {}
    for CompatibleCargo_PickUp_Type in Cargo_PickUp_Type_arr:
        LocationPickupDelivery_SplitNodes_PickUpCargoAwaiting_dict[
            CompatibleCargo_PickUp_Type] = csv_1_SplitNodes[CompatibleCargo_PickUp_Type]

    csv_1_ReliefCentres = csv_1_Locations_and_PickUp_Delivery_details[
        csv_1_Locations_and_PickUp_Delivery_details["Vertex Category"] == "Relief Centre"]
    csv_1_ReliefCentres = csv_1_ReliefCentres[[
        'Sl. No.', 'Description', 'Latitude', 'Longitude']+Cargo_PickUp_Type_arr]
    csv_1_ReliefCentres[Cargo_PickUp_Type_arr] = csv_1_ReliefCentres[Cargo_PickUp_Type_arr].astype(
        int)  # Convert columns to integer inplace
    ...
    LocationPickupDelivery_ReliefCentres_Description_dict = csv_1_ReliefCentres[
        "Description"]
    ...
    for CompatibleCargo_PickUp_Type in Cargo_PickUp_Type_arr:
        LocationPickupDelivery_ReliefCentres_PickUpCargoSpaceAvailable_dict[
            CompatibleCargo_PickUp_Type] = csv_1_ReliefCentres[CompatibleCargo_PickUp_Type]

    csv_1_Vehicle_Cargo_LUTime = csv_1_Vehicle_Cargo_Compatibility_and_Loading_Unloading_Time.drop([
                                                                                                   "Remarks/Comments"], axis=1)
    ...
    for CompatibleCargo_Delivery_Type in Cargo_Delivery_Type_arr:
        VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[
            CompatibleCargo_Delivery_Type] = csv_1_Vehicle_Cargo_LUTime[CompatibleCargo_Delivery_Type]

    VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict = {}
    for CompatibleCargo_PickUp_Type in Cargo_PickUp_Type_arr:
        VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[
            CompatibleCargo_PickUp_Type] = csv_1_Vehicle_Cargo_LUTime[CompatibleCargo_PickUp_Type]

    # Filter columns based on column names starting with "Multimodal Compatibility for"
    csv_2_vehicle_multimodal_compatibility = csv_0_Vehicles.rename(
        columns={'Vehicle Type': 'Multimodal Compatibility for '})
    csv_2_vehicle_multimodal_compatibility.set_index(
        'Multimodal Compatibility for ', inplace=True)
    filtered_columns_vehicle_multimodal = [
        col for col in csv_2_vehicle_multimodal_compatibility.columns if col.startswith("Multimodal Compatibility for ")]
    # Select columns from the DataFrame based on the filtered column names
    csv_2_vehicle_multimodal_compatibility = csv_2_vehicle_multimodal_compatibility[
        filtered_columns_vehicle_multimodal]
    csv_2_vehicle_multimodal_compatibility.columns = [col.split(
        "Multimodal Compatibility for ", 1)[-1].strip() for col in csv_2_vehicle_multimodal_compatibility.columns]

    csv_2_location_multimodal_compatibility = csv_1_Locations_and_PickUp_Delivery_details.rename(
        columns={'Sl. No.': 'Multimodal Compatibility for '},)
    # The modal compatibility for Vehicle Depots is inferred from the types of Vehicle contained within it
    csv_2_location_multimodal_compatibility.drop(
        csv_2_location_multimodal_compatibility[csv_2_location_multimodal_compatibility['Vertex Category'] == 'Vehicle Depot'].index, inplace=True)
    csv_2_location_multimodal_compatibility.set_index(
        'Multimodal Compatibility for ', inplace=True)
    filtered_columns_location_multimodal = [
        col for col in csv_2_location_multimodal_compatibility.columns if col.startswith("Multimodal Compatibility for ")]
    # Select columns from the DataFrame based on the filtered column names
    csv_2_location_multimodal_compatibility = csv_2_location_multimodal_compatibility[
        filtered_columns_location_multimodal]
    csv_2_location_multimodal_compatibility.columns = [col.split(
        "Multimodal Compatibility for ", 1)[-1].strip() for col in csv_2_location_multimodal_compatibility.columns]

    csv_2_multimodal_compatibility = pd.concat(
        [csv_2_vehicle_multimodal_compatibility, csv_2_location_multimodal_compatibility])
    ...
    for vehicle_types in Vehicles_Specifications_VehicleType_arr:
        ...
        for pickup_cargos in PU:
            ...
            if VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[pickup_cargos][vehicle_types] > 0:
                print(pickup_cargos, vehicle_types,
                      VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[pickup_cargos][vehicle_types])
        ...
        for delivery_cargos in DY:
            ...
            if VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[delivery_cargos][vehicle_types] > 0:
                print(delivery_cargos, vehicle_types,
                      VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[delivery_cargos][vehicle_types])
    ...
    All_Longitudes = {**LocationPickupDelivery_VehicleDepots_Longitude_dict, **LocationPickupDelivery_Warehouses_Longitude_dict, **LocationPickupDelivery_SimultaneousNodes_Longitude_dict,
                      **LocationPickupDelivery_TranshipmentPorts_Longitude_dict, **LocationPickupDelivery_SplitNodes_Longitude_dict, **LocationPickupDelivery_ReliefCentres_Longitude_dict}
    All_Latitudes = {**LocationPickupDelivery_VehicleDepots_Latitude_dict, **LocationPickupDelivery_Warehouses_Latitude_dict, **LocationPickupDelivery_SimultaneousNodes_Latitude_dict,
                     **LocationPickupDelivery_TranshipmentPorts_Latitude_dict, **LocationPickupDelivery_SplitNodes_Latitude_dict, **LocationPickupDelivery_ReliefCentres_Latitude_dict}
    ...
    for vehicle_type in Vehicles_Specifications_VehicleType_arr:
        ...
        csv_Travel_Times[vehicle_type] = pd.read_csv(os.path.join(default_location_of_CSV, 'Travel_Times_for_'+vehicle_type+'.csv'))
        # csv_Travel_Times[vehicle_type].dropna(inplace=True) # To remove rows which return NaN values
        # Replace NaN values with large_value
        csv_Travel_Times[vehicle_type].fillna(99999999, inplace=True)

        for num, row in csv_Travel_Times[vehicle_type].iterrows():
            # print(row['start_point_id'])
            # print(row['end_point_id'])
            # print(row['travel_time'])
            C[row['start_point_id'], row['end_point_id'],
                vehicle_type] = row['travel_time']
            C[row['end_point_id'], row['start_point_id'],
                vehicle_type] = row['travel_time']
    ...
    for simultaneous_node in NM:
        ...
        for pickup_cargo in PU:
            Un_Satisfied_Simultaneous_Nodes[simultaneous_node][
                pickup_cargo] = LocationPickupDelivery_SimultaneousNodes_PickUpCargoAwaiting_dict[pickup_cargo][simultaneous_node]
        for delivery_cargo in DY:
            Un_Satisfied_Simultaneous_Nodes[simultaneous_node][
                delivery_cargo] = LocationPickupDelivery_SimultaneousNodes_DeliveryCargoRequired_dict[delivery_cargo][simultaneous_node]
    ...
    for modal_column_heading in csv_2_multimodal_compatibility:
        ...
        # Binary decider indicating if any vehicle type works in this mode
        does_any_vehicle_work_in_this_mode = 0

        for vehicle_type in Vehicles_Specifications_VehicleType_arr:
            if csv_2_multimodal_compatibility[modal_column_heading][vehicle_type]:

                does_any_vehicle_work_in_this_mode = 1
                mode_key_value_setofVehicleTypes[modal_column_heading].append(
                    vehicle_type)
                # break
    ...
    Vehicles_Specifications_VolumeCapacity_dict[random.choice(
        mode_key_value_setofVehicleTypes["Road"])]
    ...
    list(Un_Satisfied_Simultaneous_Nodes.keys()) + \
        list(Un_Satisfied_Split_Nodes.keys())
    ...
    routes_by_vehicle_type = {vehicle_type: []
                              for vehicle_type in Vehicles_Specifications_VehicleType_arr}
    ...
    def find_nearest_warehouse(current_node, Q, mode, selected_vehicle_type, node_required_delivery):
        ...
        if warehouses_with_enough_quantities:
            ...
            nearest_warehouse = min(
                warehouses_with_enough_quantities,
                key=lambda warehouse: calculate_distance(
                    current_node, warehouse, selected_vehicle_type),
            )
    ...
    def find_nearest_relief_centre(current_node, Q, mode, selected_vehicle_type, node_required_pickup):
        ...
        if relief_centres_with_enough_quantities:
            ...
            nearest_relief_centre = min(
                relief_centres_with_enough_quantities,
                key=lambda rc: calculate_distance(
                    current_node, rc, selected_vehicle_type),
            )
    ...
    def find_satisfied_quantity_for_split_node(node, nearest_warehouse, nearest_relief_centre, Q, vehicle_type):
        ...
        if nearest_warehouse != False:
            ...
            for cargo in DY:
                ...
                # No cargo amount is carried if the vehicle is incompatible to carry it
                if VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[cargo][vehicle_type] == -1:
        ...
        if nearest_relief_centre != False:
            ...
            for cargo in PU:
                ...
                # Keep track of remaining capacity of vehicle
                x = min(Q[cargo, node], Q[cargo, nearest_relief_centre])
    ...
    def barcode_warehouse(warehouse_id, required_delivery, Q):
        barcode = {}
        for cargo in DY:
            barcode[cargo] = min(Q[cargo, warehouse_id],
                                 required_delivery[cargo])
        for cargo in PU:
            barcode[cargo] = 0
        return barcode
    ...
    def barcode_relief_centre(relief_id, required_pickup, Q):
        ...
        for cargo in DY:
            barcode[cargo] = 0
        for cargo in PU:
            barcode[cargo] = -1*min(Q[cargo, relief_id],
                                    required_pickup[cargo])
        return barcode
    ...
    def satisfy_nodes(dynamic_set, Q):
        ...
        while dynamic_set:
            ...
            transport_modes = [
                mode for mode in Allowable_Modes if can_access_vertex_or_vehicleType_multimodal(mode, node_id)]
    ...
    #             continue
            ...
            while transport_modes:
                ...
                # May be added again if the chosen Node is of NP type
                transport_modes.remove(mode)
                ...
                while available_vehicle_types:
                    ...
                    if node_id in NM:
                        ...
                        # Checks if the Vehicle capacities are enough for satisfying the needs of the Simultaneous Node's requirements
                        if can_carry_load(vehicle_type, node_id, Q):
                            required_delivery = {
                                cargo: Q[cargo, node_id] for cargo in DY}
                            required_pickup = {
                                cargo: Q[cargo, node_id] for cargo in PU}
                            ...
                            barcode_at_node = {}
                            for cargo in DY:
                                barcode_at_node[cargo] = - \
                                    1*required_delivery[cargo]
                            for cargo in PU:
                            ...
                            while any(required_delivery[cargo] > 0 for cargo in DY):
                                warehouse_id = find_nearest_warehouse(
                                    curr_node, Q, mode, vehicle_type, required_delivery)
                                ...
                                barcode = barcode_warehouse(
                                    warehouse_id, required_delivery, Q)
                                route[warehouse_id] = barcode
                                update_capacities_warehouses(
                                    warehouse_id, required_delivery, Q)
                            ...
                            while any(required_pickup[cargo] > 0 for cargo in PU):
                                relief_id = find_nearest_relief_centre(
                                    curr_node, Q, mode, vehicle_type, required_pickup)

                                if relief_id == None:  # Indicates Vehicle Type change is necessary due to Vehicle~Cargo Compatibility
                                    break

                                barcode = barcode_relief_centre(
                                    relief_id, required_pickup, Q)
                                route[relief_id] = barcode
                                update_capacities_relief_centres(
                                    relief_id, required_pickup, Q)
                                curr_node = relief_id
                        ...
                        if any((Q[cargo, node_id] > 0 and VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[cargo][vehicle_type] != -1) for cargo in DY) or any((Q[cargo, node_id] > 0 and VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[cargo][vehicle_type] != -1) for cargo in PU):
                            ...
                            for cargo in DY:
                                if Q[cargo, node_id] > 0 and VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[cargo][vehicle_type] != -1:
                                    a = True
                            if a == True:
                                warehouse_id = find_nearest_warehouse_for_split_node(
                                    node_id, Q, mode, vehicle_type)
                            else:
                                warehouse_id = False
                            ...
                            for cargo in PU:
                                if Q[cargo, node_id] > 0 and VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[cargo][vehicle_type] != -1:
                                    a = True
                            if a == True:
                                relief_id = find_nearest_relief_centre_for_split_node(
                                    node_id, Q, mode, vehicle_type)
                            else:
                                relief_id = False

                            # If both ids are False, we continue the loop for another Vehicle Type
                            if not (relief_id or warehouse_id):
                                # (since either the Vehicle Type was incompatible or the mode needs to be changed)
                                # available_vehicle_types.remove(vehicle_type)
                                continue

                            satisfied_quantity = find_satisfied_quantity_for_split_node(
                                node_id, warehouse_id, relief_id, Q, vehicle_type)
                            ...
                            for cargo in DY:
                                barcode_at_node[cargo] = -1 * \
                                    satisfied_quantity[cargo]
                            ...
                            for cargo in PU:
                                ...
                                barcode_at_relief_centre[cargo] = - \
                                    1*satisfied_quantity[cargo]
                            if warehouse_id == False:
                                route = {node_id: barcode_at_node,
                                         relief_id: barcode_at_relief_centre}
                            elif relief_id == False:
                                route = {
                                    warehouse_id: barcode_at_warehouse, node_id: barcode_at_node}
                            else:
                                route = {warehouse_id: barcode_at_warehouse,
                                         node_id: barcode_at_node, relief_id: barcode_at_relief_centre}
                            print("Route: ", route)
                            print("Q: ", Q)
                            routes_by_vehicle_type[vehicle_type].append(route)
                            break
            ...
            print("Nodes that must be Satisfied by Transhipment: ",
                  need_to_be_satisfied_by_transhipment)
            print("Nodes that CANNOT be satisfied due to lack of MODE access: ",
                  nodes_which_CANNOT_be_satisfied_due_to_lack_of_MODE_access)
    ...
    # route refers to the new route which is to be inserted after the curr_route
    def times(route, vehicle_type, curr_route):
        # This is the last node of the current route, i.e. the current vehicle location
        ...
        for ele in route:
            ...
            for cargo in curr_dict:
                if cargo in DY:
                    curr_time += VehicleCompatibility_LoadingUnloadingTime_CargoDeliveryTime_dict[cargo][vehicle_type]*abs(
                        curr_dict[cargo])
                else:
                    curr_time += VehicleCompatibility_LoadingUnloadingTime_CargoPickUpTime_dict[cargo][vehicle_type]*abs(
                        curr_dict[cargo])
    ...
    for vehicle_depot, vehicle_type in vN:
        ...
        for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
            dynamic_time[vehicle_type, vehicle_depot,
                         vehicle_no] = [0, vehicle_depot]
    ...
    for vehicle_type in Vehicles_Specifications_VehicleType_arr:
        ...
        for route in routes_by_vehicle_type[vehicle_type]:
            ...
            for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
                for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                    t, l_node = times(
                        route, vehicle_type, dynamic_time[vehicle_type, vehicle_depot, vehicle_no])
                    if t < mini:
                        mini = t
                        vd = vehicle_depot
                        vh_no = vehicle_no
            ...
            print("Route: ", route)
            print("Dynamic time: ",
                  dynamic_time[vehicle_type, vd, vh_no], "\n")

        if not vehicle_type in OT:
            for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
                for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                    if dynamic_time[vehicle_type, vehicle_depot, vehicle_no][0] != 0:
                        dynamic_time[vehicle_type, vehicle_depot, vehicle_no][0] += C[dynamic_time[vehicle_type,
                                                                                                   vehicle_depot, vehicle_no][1], vehicle_depot, vehicle_type]
                        dynamic_time[vehicle_type, vehicle_depot,
                                     vehicle_no][1] = vehicle_depot
        ...
        for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
            for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                print("\n Vehicle ID: ", vehicle_type,
                      ",", vehicle_depot, ",", vehicle_no)
                print("Total Route Time: ", dynamic_time[vehicle_type, vehicle_depot, vehicle_no]
                      [0], ", Final Vertex: ", dynamic_time[vehicle_type, vehicle_depot, vehicle_no][1])

                if dynamic_time[vehicle_type, vehicle_depot, vehicle_no][0] > max_T_before_perturbation:
                    max_T_before_perturbation = dynamic_time[vehicle_type,
                                                             vehicle_depot, vehicle_no][0]
    ...
    print("Maximum Route Time before any Perturbation: ",
          max_T_before_perturbation, " seconds/hours/units")
    ...
    for vehicle_type in Vehicles_Specifications_VehicleType_arr:
        for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
            for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                ...
                # Iten refers to a satisfied Route Segment in the Complete Route of the specific vehicle
                for item in list_of_routes[vehicle_type, vehicle_depot, vehicle_no]:
                    temp_array = []
                    for i in range(cols):
                    ...
                    for key in item:
                        ...
                        i = i+1
                    cols += i
                    perturb_array[vehicle_type, vehicle_depot,
                                  vehicle_no].append(temp_array)
                rows = len(perturb_array[vehicle_type,
                           vehicle_depot, vehicle_no])
                ...
                for row in range(rows):
                    curr_size = len(
                        perturb_array[vehicle_type, vehicle_depot, vehicle_no][row])
                    # print(curr_size)
                    while curr_size < cols:
                        perturb_array[vehicle_type, vehicle_depot,
                                      vehicle_no][row].append([False, False])
    ...
    for vehicle_type in Vehicles_Specifications_VehicleType_arr:
        for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
            for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                ...
                print("\n Perturbation for Vehicle UID: ", vehicle_type, ",", vehicle_depot, ",", vehicle_no, ", with length of the Perturb Array: ", len(
                    perturb_array[vehicle_type, vehicle_depot, vehicle_no]), " (equal to the no. of rows)")

                if len(perturb_array[vehicle_type, vehicle_depot, vehicle_no]) == 0:
                    perturbed_route_time_mapping[vehicle_type,
                                                 vehicle_depot, vehicle_no] = 0
                    continue
                    ...
                    for j in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no][0])):
                        ...
                        for i in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no])):
                            if perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][0] != False:
                                initial_route.append({perturb_array[vehicle_type, vehicle_depot, vehicle_no]
                                                     [i][j][0]: perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][1]})
                                break
                    # print(initial_route)
                    temp = final_time(
                        initial_route, vehicle_type, vehicle_depot)
                    x = 0
                    # print(temp)
                    while x < 1000:
                        random_number_x = random.randint(
                            0, len(perturb_array[vehicle_type, vehicle_depot, vehicle_no])-1)
                        # print('random_number_x:',random_number_x)
                        random_number_y = random.randint(
                            0, len(perturb_array[vehicle_type, vehicle_depot, vehicle_no][0])-1)
                        ...
                        if perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y][0] != False:
                            ...
                            # print('d:',d)
                            # The last condition makes it understand that the new column in the original row of the perturbation should be empty
                            if random_number_y+d >= 0 and random_number_y+d < len(perturb_array[vehicle_type, vehicle_depot, vehicle_no][0]) and perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y+d][0] == False:
                                print("Perturbed:: Row:", random_number_x, ", Column:",
                                      random_number_y, ", in the Direction:", d)
                                target_row = -1
                                for i in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no])):
                                ...
                                for j in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no][0])):
                                    if j == random_number_y:
                                        route.append({perturb_array[vehicle_type, vehicle_depot, vehicle_no][target_row][random_number_y+d]
                                                     [0]: perturb_array[vehicle_type, vehicle_depot, vehicle_no][target_row][random_number_y+d][1]})
                                    elif j == random_number_y+d:
                                        route.append({perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y]
                                                     [0]: perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y][1]})
                                    else:
                                        for i in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no])):
                                            if perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][0] != False:
                                                route.append(
                                                    {perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][0]: perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][1]})
                                                break
                                # print('route:',route)
                                if feasible(route, vehicle_type):
                                    ...
                                    # print(route)
                                    t = final_time(
                                        route, vehicle_type, vehicle_depot)
                                    # print(t)
                                    if t < temp:
                                        ...
                                        print("Time Improvement: ",
                                              temp-t, " seconds")
                                        temp = t
                                        perturb_array[vehicle_type, vehicle_depot, vehicle_no][target_row][random_number_y] = perturb_array[
                                            vehicle_type, vehicle_depot, vehicle_no][target_row][random_number_y+d]
                                        perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y +
                                                                                                                d] = perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y]
                                        perturb_array[vehicle_type, vehicle_depot, vehicle_no][random_number_x][random_number_y] = [
                                            False, False]
                                        perturb_array[vehicle_type, vehicle_depot,
                                                      vehicle_no][target_row][random_number_y+d] = [False, False]
                                    else:
    ...
    print("Maximum Route Time before any Perturbation: ",
          round(max_T_before_perturbation, 5))
        ...
        for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
            for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                ...
                if list_of_routes[vehicle_type, vehicle_depot, vehicle_no]:
                    print("\nOriginal Route Time: ", dynamic_time[vehicle_type, vehicle_depot, vehicle_no]
                          [0], ", Final Vertex: ", dynamic_time[vehicle_type, vehicle_depot, vehicle_no][1])
                ...
                if perturb_array[vehicle_type, vehicle_depot, vehicle_no]:
                    ...
                    for j in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no][0])):
                        ...
                        for i in range(len(perturb_array[vehicle_type, vehicle_depot, vehicle_no])):
                            if perturb_array[vehicle_type, vehicle_depot, vehicle_no][i][j][0] != False:
                                string_perturbed_route += perturb_array[vehicle_type,
                                                                        vehicle_depot, vehicle_no][i][j][0]
                                string_perturbed_route += "  -=>  "
                                break
                    print(string_perturbed_route[: -5])
                    print("Original Route Time: ", perturbed_route_time_mapping[(
    ...
    if len(perturb_array[vehicle_type, vehicle_depot, vehicle_no]) > 0:
        ...
        # Handle the error
        print(
            f"List is empty: {perturb_array[vehicle_type,vehicle_depot,vehicle_no]}")
        ...
        for vehicle_depot in vehicle_depots_in_vehicle_type[vehicle_type]:
            for vehicle_no in range(1, vN[vehicle_depot, vehicle_type]+1):
                ...
                for single_route in list_of_routes[vehicle_type, vehicle_depot, vehicle_no]:
                    ...
                    loadcodes_of_each_vehicle[Vehicle].extend(
                        single_route.values())

            # print()
            # print(route_of_each_vehicle[Vehicle])

    route_of_each_vehicle = pd.DataFrame(
        route_of_each_vehicle.items(), columns=['Keys', 'Values'])
    # route_of_each_vehicle.rename(columns={'Values': 'Vertices Visited'}), inplace=True)
    route_of_each_vehicle = route_of_each_vehicle.rename(
        columns={'Values': 'Vertices Visited'})
    route_of_each_vehicle

    loadcodes_of_each_vehicle = pd.DataFrame(
        loadcodes_of_each_vehicle.items(), columns=['Keys', 'Values'])
    # loadcodes_of_each_vehicle.rename(columns={'Values': 'LoadCodes at each Vertex'}, inplace=True)
    loadcodes_of_each_vehicle = loadcodes_of_each_vehicle.rename(
        columns={'Values': 'LoadCodes at each Vertex'})
    loadcodes_of_each_vehicle

    merged_df = pd.merge(route_of_each_vehicle,
                         loadcodes_of_each_vehicle, on='Keys')
